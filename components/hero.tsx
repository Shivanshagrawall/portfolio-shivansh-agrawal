      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Shivansh Agrawal</h1>
            <p className="text-lg sm:text-xl text-muted-foreground">Full Stack Developer | Software Engineer</p>
          </div>

          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              <Mail className="h-4 w-4" />
              <a href="mailto:shivanshagrawal3007@gmail.com">shivanshagrawal3007@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <Link
              href="https://drive.google.com/file/d/1pN_ZtyY8V0ichDdqdwz6JNzFD2S2bVxn/view?usp=drivesdk"
              target="_blank"
              download
            >
            ...
            <Link
              href="https://github.com/Shivanshagrawall"
              target="_blank"
            >
            ...
            <Link
              href="mailto:shivanshagrawal3007@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://www.linkedin.com/in/shivansh-agrawal3007/"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
